...
*emcc ./WasmAPI.cpp ./GamesHandler.cpp ./Game.cpp ./Board.cpp ./Square.cpp ./AI.cpp ./Player.cpp -O2 -s WASM=1 -Wall -s MODULARIZE=1 -s EXTRA_EXPORTED_RUNTIME_METHODS=["UTF8ToString"] -o WasmGame.js*
...
Aby tego dokonać:
1. Uruchom wiersz polecenia
2. Przejdź do folderu (ścieżka do folderu projektu)/Testy
3. Uruchom polecenie: \
*g++ test.cpp ..\WebSocketServer\WasmGame\Square.cpp ..\WebSocketServer\WasmGame\Board.cpp ..\WebSocketServer\WasmGame\Player.cpp ..\WebSocketServer\WasmGame\Game.cpp ..\WebSocketServer\WasmGame\GamesHandler.cpp ..\WebSocketServer\WasmGame\AI.cpp -o test*
4. Uruchom polecenie: \
*./test*
